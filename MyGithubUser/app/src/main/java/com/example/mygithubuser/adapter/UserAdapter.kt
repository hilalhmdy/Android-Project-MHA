...
import com.example.mygithubuser.helper.ListTypeHelper
import com.example.mygithubuser.model.ItemsItem
import com.example.mygithubuser.ui.detail.DetailUserActivity
import com.example.mygithubuser.ui.detail.DetailUserActivity.Companion.EXTRA_USER
...
class UserAdapter(private val listUser: List<ItemsItem>) : RecyclerView.Adapter<UserAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        viewHolder.tvName.text = listUser[position].username
        ...
        viewHolder.itemView.setOnClickListener {
            ...
            intentDetail.putExtra(EXTRA_USER, ListTypeHelper.itemsItemToFavorite(listUser[position]))
